...
#SBATCH --job-name=deeptools_no_SF
#SBATCH --output=deeptools_no_SF.log
#SBATCH --error=deeptools_no_SF.err
#SBATCH --nodes=1
#SBATCH --ntasks=6
...
BW_DIR="/home/lauterw/MapR_Madison/results/bw_no_SF_ignore_duplicates"
MATRIX_DIR="/home/lauterw/MapR_Madison/results/matrix"
FIG_DIR="/home/lauterw/MapR_Madison/results/figures"
